...
__flash unsigned char Ch_lib[][24]={
  ...
  0x24,0x09,0x24,0x09,0x24,0x09,0xFC,0x0F,0x00,0x00,0x00,0x00},/*"自",81*/
  {0x80,0x00,0x92,0x00,0x92,0x00,0x92,0x08,0x92,0x08,0xFE,0x0F,
  0x91,0x00,0x91,0x00,0x91,0x00,0x91,0x00,0x80,0x00,0x00,0x00},/*"手",82*/
  //无
...
__flash unsigned char Page_Content[][PAGE_CONTENT_LENGTH]={
  ...
  //content 7
  {KONGGE,KONGGE,KONGGE,KONGGE,KONGGE,KONGGE,KONGGE,KONGGE,KONGGE,KONGGE}, /*  */
  {GEN1,BU4,JIAN1,XI4,MAOHAO,XIAOSHU,KONGGE,MM,KONGGE,KONGGE},/*根部间隙：MM */
  {KONGGE,KONGGE,KONGGE,KONGGE,KONGGE,KONGGE,KONGGE,KONGGE,KONGGE,KONGGE},/*  */
  //content 8
...
void Menu_Select(unsigned int *p){
  ...
  *(p+PAGE_BUF)=Page_Debug.Page;
  ...
  switch(Page.Page_Mult.Content){
    ...
    x=73;
    /*手？自*/
    Display_Chinese(&x,1,&Ch_lib[Mult.Mult_Res.Weld_Start_And_Stop+ZI4][0],DIS_CH);
    ...
    case 6:
    x=62;
    Display_Num(&x,2,p+ROOT_GAP_BUF,1); 
    break;
    case 11:
    /*电流 焊速 当前焊道 */
    for(i=0;i<3;i++){
